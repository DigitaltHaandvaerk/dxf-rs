...
mod tests {
    ...
    fn write_multi_leader_basic() {
        ...
        mleader.dogleg_length = 3000.366019534463;
        mleader.default_text_contents = "Great MLEADER {\\fArial;content}".to_string();
        mleader.text_location = Point::new(676536406.164786, 6147397578.003218, 41.18369923159479);
        mleader.vertices = vec![
            Point::new(676537064.180925, 6147400923.448454, 41.18369923159479),
            Point::new(676548478.6502683, 6147400741.812067, 41.18369923159479),
        ];
        ...
        assert_contains_pairs(
            ...
            vec![
                ...
                CodePair::new_f64(41, 3000.366019534463), // dogleg_length
                ...
                CodePair::new_f64(10, 0.0),   // content_base_point.x
                CodePair::new_f64(20, 0.0),   // content_base_point.y
                CodePair::new_f64(30, 0.0),   // content_base_point.z
                CodePair::new_f64(41, 0.0),   // text_height
                CodePair::new_f64(140, 0.18), // arrow_head_size
                CodePair::new_f64(145, 0.12), // landing_gap
                CodePair::new_i16(290, 0),    // has_m_text
                CodePair::new_str(304, "Great MLEADER {\\fArial;content}"), // default_text_contents
                CodePair::new_f64(11, 0.0),   // text_normal_direction.x
                CodePair::new_f64(21, 0.0),   // text_normal_direction.y
                CodePair::new_f64(31, 0.0),   // text_normal_direction.z
                CodePair::new_f64(12, 676536406.164786), // text_location.x
                CodePair::new_f64(22, 6147397578.003218), // text_location.y
                CodePair::new_f64(32, 41.18369923159479), // text_location.z
                CodePair::new_f64(13, 0.0),   // text_direction.x
                ...
                CodePair::new_i16(171, 0),    // text_attachment
                ...
                // MLeader Leader Node Group Codes
                CodePair::new_i16(290, 0), // has_set_last_leader_line_point
                CodePair::new_i16(291, 0), // has_set_dogleg_vector
                CodePair::new_f64(10, 0.0), // last_leader_line_point.x
                CodePair::new_f64(20, 0.0), // last_leader_line_point.y
                ...
                CodePair::new_f64(40, 0.0), // dogleg_length_leader
                // LEADER_LINE Section
                CodePair::new_str(304, "LEADER_LINE{"),
                // MLeader Leader Line Group Codes (vertices)
                CodePair::new_f64(10, 676537064.180925), // vertex 1 x
                CodePair::new_f64(20, 6147400923.448454), // vertex 1 y
                CodePair::new_f64(30, 41.18369923159479), // vertex 1 z
                CodePair::new_f64(10, 676548478.6502683), // vertex 2 x
                CodePair::new_f64(20, 6147400741.812067), // vertex 2 y
                CodePair::new_f64(30, 41.18369923159479), // vertex 2 z
